...
. In the Pivotal Cloud Foundry App Manager console, click on the *Manage* links for the *Config Server*. Once the service is initialized and the web form appears, paste https://github.com/pivotal-anz/cf-SpringBootTrader-config.git into the *Git URI* field and click *Submit*.
